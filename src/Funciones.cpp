...
void bajaCuenta(){
    ...
    int cuenta, opc;
    cout << "-----------------------------------------------------------"<< endl;
    cout << "----------------------- CUENTA A DESACTIVAR ---------------" << endl;
    cout << "-----------------------------------------------------------"<< endl;
    int pos=0;
    while(reg.leerDeDisco(pos)==true)
    {
        if(reg.getEstadoPlan()==true){
    ...
    cout << "-----------------------------------------------------------"<< endl;
    cout << "SELECCIONE EL CODIGO DEL PROVEEDOR QUE DESEE DAR DE BAJA:  "<< endl;
    cout << "-----------------------------------------------------------"<< endl;
    cin >> cuenta;

    char nom[45]= {};
    strcpy(nom,buscarNombreCuentaContable(cuenta));

    cout << "LA CUENTA " << nom << " SE ESTA POR DESACTIVAR. ESTA SEGURO? ";
    cout << " 1 / SI  --  2 / NO" << endl;
    cin >> opc;
    PlanDeCuentas reg2;
    if(opc == 1)
...
Proveedor reg1(1,"2MS",30708909382,902,"Buenos Aires","EX",1,0,3,1);
...
Proveedor reg7(7,"AIR LIQUIDE ARGENTINA",30500852131,902,"Buenos Aires","EX",1,0,3,1);
...
Proveedor reg11(11,"ALEJANDRO RODRIGUEZ ERAÑA",23165817389,902,"Buenos Aires","EX",1,0,3,1);
...
Proveedor reg22(22,"ARIAS PABLO GERARDO",20222641137,901,"C.A.B.A.","EX",1,0,3,1);
...
Proveedor reg32(32,"BALSEIRO DANIEL EMILIO",20139330588,901,"C.A.B.A.","EX",1,0,3,1);
Proveedor reg33(33,"Bamay Construcciones Sociedad de Responsabilidad Limitada",30716854961,901,"C.A.B.A.","RI",1,1,1,1);
...
Proveedor reg38(38,"BARREDA JUAN MANUEL",20284886918,902,"Buenos Aires","EX",1,0,3,1);
...
Proveedor reg45(45,"BIONDI ALBERTO LUCIANO",20112511521,902,"Buenos Aires","EX",1,0,3,1);
...
Proveedor reg52(52,"BRAVER HERNAN",20257708781,901,"C.A.B.A.","MT",1,0,3,1);
Proveedor reg53(53,"BRIGHINA LAURA SILVIA",20224566507,901,"C.A.B.A.","EX",1,0,3,1);
...
Proveedor reg58(58,"CALVET CELIA ALICIA",27133043077,902,"Buenos Aires","EX",1,0,3,1);
Proveedor reg59(59,"CAMARA DE EXPORTADORES DE LA REPUBLICA ARGENTINA",30525522454,902,"Buenos Aires","EX",1,0,3,1);
...
Proveedor reg64(64,"CARUBELLO MARISA ALEJANDRA",27221473596,901,"C.A.B.A.","MT",1,0,3,1);
...
Proveedor reg67(67,"CAUSA NICOLAS",20280815552,901,"C.A.B.A.","MT",1,0,3,1);
Proveedor reg68(68,"CAUSA RAUL",20045297307,901,"C.A.B.A.","MT",0,0,3,1);
...
Proveedor reg82(82,"CONDOLEO DIEGO MARTIN",20259876428,902,"Buenos Aires","MT",1,0,3,1);
Proveedor reg83(83,"COOPERALA",30541078181,916,"Rio Negro","EX",0,0,3,1);
Proveedor reg84(84,"COOPERATIVA DE TRABAJO TERMINACIONES BARRACAS LIMITADA",30716550059,902,"Buenos Aires","EX",1,0,3,1);
Proveedor reg85(85,"CORONADO MARIANA",27254405561,902,"Buenos Aires","EX",1,0,3,1);
...
Proveedor reg102(102,"DOMINGUEZ OMAR ANTONIO",20180786105,902,"Buenos Aires","MT",1,0,3,1);
Proveedor reg103(103,"DONATI CLAUDIO FABIAN",20145644683,902,"Buenos Aires","MT",1,0,3,1);
...
Proveedor reg114(114,"EMAKI LOGISTICA",20332482328,902,"Buenos Aires","MT",1,0,3,1);
...
Proveedor reg126(126,"EUROLAB",30645887111,905,"Cordoba","EX",1,0,3,1);
...
Proveedor reg135(135,"FEDERICO ESTEBAN HERNANDEZ",23205855459,902,"Buenos Aires","EX",1,0,3,1);
Proveedor reg136(136,"FEENSTRA EDUARDO F.",20100875919,902,"Buenos Aires","EX",1,0,3,1);
Proveedor reg137(137,"FERNANDEZ CONTE MACARENA SOLEDAD",27315264605,902,"Buenos Aires","EX",1,0,3,1);
...
Proveedor reg152(152,"GARBINI MARIA ANDREA",27134304028,902,"Buenos Aires","MT",1,0,3,1);
...
Proveedor reg164(164,"GONZALEZ MYRIAM AMALIA",27239028468,902,"Buenos Aires","MT",1,0,3,1);
...
Proveedor reg178(178,"GUZNER GUSTAVO VALERIO",20107058665,902,"Buenos Aires","MT",1,0,3,1);
...
Proveedor reg193(193,"INNOVA T",30663170364,902,"Buenos Aires","EX",0,0,3,1);
...
Proveedor reg202(202,"JORGE ALBERTO MARCONI",20124792208,902,"Buenos Aires","MT",1,0,3,1);
...
Proveedor reg217(217,"LAURETTI MARCELO HERNAN",20240834740,902,"Buenos Aires","MT",1,0,3,1);
...
Proveedor reg220(220,"LETCHER PABLO GERMAN",20285896267,902,"Buenos Aires","MT",1,0,3,1);
...
Proveedor reg233(233,"MARQUES ROMINA GISELLE",27270888505,902,"Buenos Aires","MT",1,0,3,1);
Proveedor reg234(234,"MARTIN S. KALOGHLIAN Y SUSANA T. KALOGHLIAN S.H.",30708402113,902,"Buenos Aires","RI",1,1,1,1);
Proveedor reg235(235,"MARTINEZ ADRIANA NOEMI",23183040774,924,"Tucuman","MT",0,0,3,1);
...
Proveedor reg251(251,"MONZON VICTOR DIEGO",20185583024,902,"Buenos Aires","MT",1,0,3,1);
...
Proveedor reg272(272,"ORGANIZACION COO ARGENTINA S R L",30536259194,913,"Mendoza","RI",1,1,1,1);
...
Proveedor reg277(277,"PABLO ALEJANDRO COCUZZO",20226451553,902,"Buenos Aires","MT",1,0,3,1);
Proveedor reg278(278,"PAGNOTTA ADRIANA IRENE",27106058755,902,"Buenos Aires","MT",1,0,3,1);
Proveedor reg279(279,"PALERMO MIGUEL ANGEL",20263289251,913,"Mendoza","MT",0,0,3,1);
...
Proveedor reg282(282,"PANZITTA ALICIA NOEMI",27126672891,902,"Buenos Aires","MT",0,0,3,1);
...
Proveedor reg285(285,"PATIÑO LOPEZ IRMA",27940754734,916,"Rio Negro","MT",0,0,3,1);
...
Proveedor reg310(310,"REFRIGERACION MARIA Y OTROS",30716747855,902,"Buenos Aires","RI",1,1,1,1);
...
Proveedor reg330(330,"SANCHEZ DELIA HAYDEE",27252204038,902,"Buenos Aires","MT",1,0,3,1);
Proveedor reg331(331,"SANCHEZ JULIO ALBERTO",20116359236,902,"Buenos Aires","MT",1,0,3,1);
...
Proveedor reg344(344,"SISTEMAS ARGENTINOS TERMICO S.A",30708578696,902,"Buenos Aires","RI",1,1,1,1);
...
Proveedor reg358(358,"TECNICAS FERROVIARIAS ARG S.A,",30657138661,902,"Buenos Aires","RI",1,1,1,1);
...
Proveedor reg365(365,"TESTLAB SOCIEDAD DE R L",30618854570,902,"Buenos Aires","RI",1,1,1,1);
...
Proveedor reg377(377,"UNION ARGENTINA PROV",30539732923,902,"Buenos Aires","EX",1,0,3,1);
Proveedor reg378(378,"VALAM S.A.I.C.",33539882819,916,"Rio Negro","RI",1,1,1,1);
Proveedor reg379(379,"VALDEZ MERELES ANALIA MABEL",27958169073,902,"Buenos Aires","MT",1,0,3,1);
...
Proveedor reg386(386,"VICTOR MASSON CRUZ DEL SUR S A",30556565798,902,"Buenos Aires","RI",1,1,1,1);
...
Proveedor reg393(393,"ZANONI FRANCO MARIO",20118357532,902,"Buenos Aires","MT",1,0,3,1);
